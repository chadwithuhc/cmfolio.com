export default {
  ...
  contact: {
    name: `Melkey Dev`,
    email: `melkeydev@gmail.com`,
    website: `https://melkeydev.com`,
    code: `github.com/melkdeydev`,
    linkedinUsername: 'melkeydev',
    githubUsername: 'melkeydev'
  },
  professional_profile: [
    `Senior JavaScript & Front-end Engineer with 10+ years in production environments`,
    `Driven by crafting component-based applications with user-focused interfaces`,
    `Looking to collaborate and build the best enterprise software in the world`,
