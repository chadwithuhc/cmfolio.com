export default {
  ...
  professional_profile: [
    `Senior JavaScript & Front End Developer with ${(new Date()).getFullYear() - 2008}+ years in production environments`,
    `Driven by crafting component-based applications with user-focused interfaces`,
    `Looking to collaborate and build applications for creatives`,
