export default {
  ...
  professional_profile: [
    `Lead JavaScript & Front-end Engineer with ${(new Date()).getFullYear() - 2008}+ years in production environments`,
    `Driven by crafting component-based applications with user-focused interfaces`,
    `Looking to collaborate and build creative and performant applications at scale`,
