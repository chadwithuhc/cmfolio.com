export default {
  name: 'home',
  intro: [
    `Howdy, I'm <a class="hashlink" title="🧀">cheddar</a>. I am a <a class="hashlink" target="_blank" rel="noopener noreferrer" href="https://denver.gteach.xyz/">teacher</a> by day and <a class="hashlink" target="_blank" rel="noopener noreferrer" href="https://twitter.com/search?l=&q=%23TIL%20from%3Achadwithuhc&src=typd">student</a> all the time 💯`,
  ...
  currently_i_am_working_on: [
    ...
    `✏️ Building fancy educational tools: <em>Everybody Writes 2.0</em>, <em>LP</em>, <em>SIS</em>`,
  ...
  recently_i_updated: [
    `🍻 Pair Programming on Everybody Writes <a href="https://www.youtube.com/watch?v=O5A1GAWBV8s" target="blank" rel="noreferrer noopener">&raquo;&raquo;</a>`,
